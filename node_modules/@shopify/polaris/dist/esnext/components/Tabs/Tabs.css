...
.Polaris-Tabs__Wrapper_mkrm3{ border-bottom:0.1rem solid var(--p-border-subdued, #dfe3e8); }
...
.Polaris-Tabs__Tab_375k2:hover .Polaris-Tabs__Title_2qj8j{ font-weight:400; color:var(--p-text, #212b36); background-color:var(--p-surface-hovered, transparent); border-bottom:var(--p-override-none, 0.3rem) solid #dfe3e8; }

.Polaris-Tabs__Tab_375k2:active .Polaris-Tabs__Title_2qj8j{ background-color:var(--p-surface-pressed, transparent); }
...
.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__Title_2qj8j{ padding:0.8rem 1.6rem; font-weight:var(--p-button-font-weight); }
...
.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__Tab_375k2:hover .Polaris-Tabs__Title_2qj8j, .Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__Tab_375k2:active .Polaris-Tabs__Title_2qj8j, .Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__Tab_375k2:focus .Polaris-Tabs__Title_2qj8j{ font-weight:var(--p-button-font-weight); }
...
.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__Tab--selected_11sap .Polaris-Tabs__Title_2qj8j{ background-color:var(--p-surface-primary-selected); color:var(--p-action-primary); }
