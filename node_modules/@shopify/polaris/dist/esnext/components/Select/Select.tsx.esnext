...
import styles from './Select.scss.esnext';
...
function Select({
  ...
  const inlineLabelMarkup = labelInline && /*#__PURE__*/React$1.createElement("span", {
    className: styles.InlineLabel
  }, label);
  const selectedOption = getSelectedOption(normalizedOptions, value);
  const contentMarkup = /*#__PURE__*/React$1.createElement("div", {
    className: styles.Content,
    "aria-hidden": true,
    "aria-disabled": disabled
  }, inlineLabelMarkup, /*#__PURE__*/React$1.createElement("span", {
