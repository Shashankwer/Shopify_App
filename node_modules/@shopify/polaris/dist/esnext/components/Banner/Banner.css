...
.Polaris-Banner--withinContentContainer_1uwmg.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--hasDismiss_kf0ua{ padding-right:calc(3.2rem + var(--p-icon-size)); }
...
.Polaris-Banner--newDesignLanguage_1rik8 .Polaris-Banner--withinContentContainer_1uwmg .Polaris-Banner__Ribbon_r8z8p{ padding-right:1.6rem; }
...
.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusCritical_1iy3d .Polaris-Banner__PrimaryAction_eeemy > button{ border-color:var(--p-border-critical-subdued); background:var(--p-surface-critical-subdued); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusCritical_1iy3d .Polaris-Banner__PrimaryAction_eeemy > button:hover{ border-color:var(--p-border-critical-subdued); background:var(--p-surface-critical-subdued-hovered); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusCritical_1iy3d .Polaris-Banner__PrimaryAction_eeemy > button:active{ border-color:var(--p-border-critical-subdued); background:var(--p-surface-critical-subdued-pressed); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusCritical_1iy3d .Polaris-Banner__PrimaryAction_eeemy > button:focus:not(:active){ border-color:var(--p-border-critical-subdued); background:var(--p-surface-critical-subdued); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusWarning_1x66d .Polaris-Banner__PrimaryAction_eeemy > button{ border-color:var(--p-border-warning-subdued); background:var(--p-surface-warning-subdued); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusWarning_1x66d .Polaris-Banner__PrimaryAction_eeemy > button:hover{ border-color:var(--p-border-warning-subdued); background:var(--p-surface-warning-subdued-hovered); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusWarning_1x66d .Polaris-Banner__PrimaryAction_eeemy > button:active{ border-color:var(--p-border-warning-subdued); background:var(--p-surface-warning-subdued-pressed); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusWarning_1x66d .Polaris-Banner__PrimaryAction_eeemy > button:focus:not(:active){ border-color:var(--p-border-warning-subdued); background:var(--p-surface-warning-subdued); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusInfo_knr66 .Polaris-Banner__PrimaryAction_eeemy > button{ border-color:var(--p-border-highlight-subdued); background:var(--p-surface-highlight-subdued); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusInfo_knr66 .Polaris-Banner__PrimaryAction_eeemy > button:hover{ border-color:var(--p-border-highlight-subdued); background:var(--p-surface-highlight-subdued-hovered); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusInfo_knr66 .Polaris-Banner__PrimaryAction_eeemy > button:active{ border-color:var(--p-border-highlight-subdued); background:var(--p-surface-highlight-subdued-pressed); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusInfo_knr66 .Polaris-Banner__PrimaryAction_eeemy > button:focus:not(:active){ border-color:var(--p-border-highlight-subdued); background:var(--p-surface-highlight-subdued); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusSuccess_pc5rl .Polaris-Banner__PrimaryAction_eeemy > button{ border-color:var(--p-border-success-subdued); background:var(--p-surface-success-subdued); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusSuccess_pc5rl .Polaris-Banner__PrimaryAction_eeemy > button:hover{ border-color:var(--p-border-success-subdued); background:var(--p-surface-success-subdued-hovered); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusSuccess_pc5rl .Polaris-Banner__PrimaryAction_eeemy > button:active{ border-color:var(--p-border-success-subdued); background:var(--p-surface-success-subdued-pressed); }

.Polaris-Banner--newDesignLanguage_1rik8.Polaris-Banner--statusSuccess_pc5rl .Polaris-Banner__PrimaryAction_eeemy > button:focus:not(:active){ border-color:var(--p-border-success-subdued); background:var(--p-surface-success-subdued); }
