...
import { globalIdGeneratorFactory } from '../../utilities/unique-id/unique-id-factory.ts.esnext';
...
import { ResourceListContext } from '../../utilities/resource-list/context.ts.esnext';
import { SELECT_ALL_ITEMS } from '../../utilities/resource-list/types.ts.esnext';
...
class BaseResourceItem extends Component {
  ...
  render() {
    ...
    const listItemClassName = classNames(styles.ListItem, focused && !focusedInner && styles.focused, newDesignLanguage && styles.newDesignLanguage);
