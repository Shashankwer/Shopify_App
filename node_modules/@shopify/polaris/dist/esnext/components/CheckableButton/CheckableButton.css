...
.Polaris-CheckableButton--newDesignLanguage_1rik8 .Polaris-CheckableButton__Checkbox_1d6zr{ height:var(--p-choice-size); width:var(--p-choice-size); margin-left:calc(-0.8rem - var(--p-control-border-width)); }
