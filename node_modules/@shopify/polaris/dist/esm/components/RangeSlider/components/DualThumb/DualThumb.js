...
class DualThumb extends Component {
  ...
  render() {
    ...
    var thumbLowerClassName = classNames(styles.Thumbs, styles.ThumbLower, disabled && styles.disabled, this.context && this.context.newDesignLanguage && styles.newDesignLanguage);
    var thumbUpperClassName = classNames(styles.Thumbs, styles.ThumbUpper, disabled && styles.disabled, this.context && this.context.newDesignLanguage && styles.newDesignLanguage);
