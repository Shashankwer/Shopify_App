...
class FiltersInner extends Component {
  ...
  render() {
    ...
    var filtersContentMarkup = filters.map((filter, index) => {
      ...
      var buttonClassName = classNames(styles.FilterTrigger, newDesignLanguage && styles.newDesignLanguage);
    ...
    var filtersContainerHeaderClassname = classNames(styles.FiltersContainerHeader, newDesignLanguage && styles.newDesignLanguage);
    ...
    var filtersDesktopFooterClassname = classNames(styles.FiltersContainerFooter, newDesignLanguage && styles.newDesignLanguage);
    ...
    var tagsMarkup = !hideTags && appliedFilters && appliedFilters.length ? /*#__PURE__*/React$1.createElement("div", {
    ...
    var filtersMobileContainerContentClassName = classNames(styles.FiltersMobileContainerContent, newDesignLanguage && styles.newDesignLanguage);
    var filtersDesktopContainerContentClassName = classNames(styles.FiltersDesktopContainerContent, newDesignLanguage && styles.newDesignLanguage);
