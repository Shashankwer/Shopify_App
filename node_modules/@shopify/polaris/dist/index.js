...
var WithinFilterContext = /*#__PURE__*/React.createContext(false);
...
function Badge({
  ...
  var i18n = useI18n();
  var withinFilter = React.useContext(WithinFilterContext);
  var className = classNames(styles$7.Badge, status && styles$7[variationName('status', status)], progress && styles$7[variationName('progress', progress)], size && size !== DEFAULT_SIZE && styles$7[variationName('size', size)], withinFilter && styles$7.withinFilter);
  var progressMarkup;
...
function Item({
  ...
  var textMarkup = /*#__PURE__*/React__default.createElement("div", {
...
function Section$1({
  ...
  var actionsClassName = classNames(styles$9.Actions, newDesignLanguage && styles$9.newDesignLanguage);
...
function ButtonGroup({
  ...
  var className = classNames(styles$b.ButtonGroup, spacing && styles$b[spacing], segmented && styles$b.segmented, fullWidth && styles$b.fullWidth);
...
function SecondaryAction(_ref) {
  var {
    ...
    getOffsetWidth
      ...
      rest = _objectWithoutProperties(_ref, ["children", "getOffsetWidth"]);

  var {
    newDesignLanguage
  } = useFeatures();
  var secondaryActionsRef = React.useRef(null);
  React.useEffect(() => {
  ...
  }, /*#__PURE__*/React__default.createElement(Button, rest, children));
}
...
function MenuGroup({
  ...
  var popoverActivator = newDesignLanguage ? /*#__PURE__*/React__default.createElement(SecondaryAction, {
    disclosure: true,
    icon: icon,
...
function Actions({
  ...
  var actionsLayoutRef = React.useRef(null);
  var menuGroupRef = React.useRef(null);
  var menuGroupWidthRef = React.useRef(0);
  var [actionWidths, setActionWidths] = React.useState([]);
  var [availableWidth, setAvailableWidth] = React.useState(0);
  var [activeMenuGroup, setActiveMenuGroup] = React.useState(undefined);
  var [showableActions, setShowableActions] = React.useState(null);
  var [hiddenActions, setHiddenActions] = React.useState([]);
  var handleOffsetWidth = React.useCallback(width => setActionWidths(actionWidths => [...actionWidths, width]), []);
  ...
  var handleResize = React.useMemo(() => debounce(() => {
  ...
  var className = classNames(styles$l.ActionsLayout, newDesignLanguage && styles$l.newDesignLanguage);
  ...
  var actionMarkup = overriddenActions.map((action, index) => {
    if ('title' in action) {
      ...
      return _actions.length > 0 ? /*#__PURE__*/React__default.createElement("div", {
        key: "MenuGroup-".concat(index),
        ref: menuGroupRef
      }, /*#__PURE__*/React__default.createElement(MenuGroup, Object.assign({
        title: title,
  ...
  }, newDesignLanguage ? /*#__PURE__*/React__default.createElement(ButtonGroup, {
    spacing: "extraTight"
  }, showableActions && showableActions.length > 0 ? showableActions.map(action => /*#__PURE__*/React__default.createElement(SecondaryAction, Object.assign({
    key: action.content
  }, action, {
    getOffsetWidth: handleOffsetWidth
  }), action.content)) : null, actionMarkup) : actionMarkup, /*#__PURE__*/React__default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }));
}
...
function RollupActions({
  ...
  var classname = classNames(styles$m.RollupActivator, newDesignLanguage && styles$m.newDesignLanguage);
  var {
    value: rollupOpen,
...
function ActionMenu({
  ...
  var actionMenuClassNames = classNames(styles$n.ActionMenu, rollup && styles$n.rollup);
...
function Checkbox({
  ...
  var className = classNames(styles$o.Checkbox, active && styles$o.active, newDesignLanguage && styles$o.newDesignLanguage);
  ...
  var inputClassName = classNames(styles$o.Input, newDesignLanguage && keyFocused && styles$o.keyFocused);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
...
function Option({
  ...
  var singleSelectClassName = classNames(styles$p.SingleSelectOption, focused && styles$p.focused, disabled && styles$p.disabled, select && styles$p.select, active && styles$p.active);
  var multiSelectClassName = classNames(styles$p.Label, disabled && styles$p.disabled, active && styles$p.active, newDesignLanguage && select && styles$p.select);
  ...
  var optionClassName = classNames(styles$p.Option, newDesignLanguage && styles$p.newDesignLanguage);
  return /*#__PURE__*/React__default.createElement("li", {
    key: id,
...
function OptionList({
  ...
  var optionListClassName = classNames(styles$q.OptionList, newDesignLanguage && styles$q.newDesignLanguage);
...
function Label({
  ...
  var className = classNames(styles$s.Label, hidden && styles$s.hidden);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
...
function Labelled(_ref) {
  ...
  var className = classNames(labelHidden && styles$u.hidden);
...
class Item$3 extends React.PureComponent {
  ...
  render() {
    ...
    var className = classNames(styles$v.Item, focused && styles$v['Item-focused'], position === 'primary' ? styles$v['Item-primary'] : styles$v['Item-connection']);
    return /*#__PURE__*/React__default.createElement("div", {
...
function Connected({
  ...
  var className = classNames(styles$v.Connected, newDesignLanguage && styles$v.newDesignLanguage);
...
function TextField({
  ...
  var className = classNames(styles$w.TextField, Boolean(normalizedValue) && styles$w.hasValue, disabled && styles$w.disabled, readOnly && styles$w.readOnly, error && styles$w.error, multiline && styles$w.multiline, focus && styles$w.focus, newDesignLanguage && styles$w.newDesignLanguage);
  ...
  if (showCharacterCount) {
    ...
    var characterCountClassName = classNames(styles$w.CharacterCount, multiline && styles$w.AlignFieldBottom);
  ...
  var inputClassName = classNames(styles$w.Input, align && styles$w[variationName('Input-align', align)], suffix && styles$w['Input-suffixed'], clearButton && styles$w['Input-hasClearButton']);
  ...
  var backdropClassName = classNames(styles$w.Backdrop, newDesignLanguage && connectedLeft && styles$w['Backdrop-connectedLeft'], newDesignLanguage && connectedRight && styles$w['Backdrop-connectedRight']);
...
function Backdrop(props) {
  ...
  var className = classNames(styles$y.Backdrop, belowNavigation && styles$y.belowNavigation, transparent && styles$y.transparent);
...
var Banner = /*#__PURE__*/React.forwardRef(function Banner({
  ...
  var className = classNames(styles$z.Banner, status && styles$z[variationName('status', status)], onDismiss && styles$z.hasDismiss, shouldShowFocus && styles$z.keyFocused, withinContentContainer ? styles$z.withinContentContainer : styles$z.withinPage, newDesignLanguage && styles$z.newDesignLanguage);
...
function useBannerAttributes(status, newDesignLanguage) {
  switch (status) {
    ...
    case 'critical':
      return {
        defaultIcon: polarisIcons.CircleDisabledMajor,
...
class Breadcrumbs extends React.PureComponent {
  ...
  render() {
    ...
    var breadcrumbClassNames = classNames(styles$A.Breadcrumb, newDesignLanguage && styles$A.newDesignLanguage);
...
function Choice({
  ...
  var className = classNames(styles$B.Choice, labelHidden && styles$B.labelHidden, disabled && styles$B.disabled);
...
var Checkbox$1 = /*#__PURE__*/React.forwardRef(function Checkbox({
  ...
  var wrapperClassName = classNames(styles$C.Checkbox, error && styles$C.error, newDesignLanguage && styles$C.newDesignLanguage);
  var backdropClassName = classNames(styles$C.Backdrop, mouseOver && styles$C.hover);
  ...
  var inputClassName = classNames(styles$C.Input, isIndeterminate && styles$C['Input-indeterminate'], newDesignLanguage && keyFocused && styles$C.keyFocused);
  return (
    /*#__PURE__*/
...
function Indicator({
  ...
  var className = classNames(styles$E.Indicator, pulse && styles$E.pulseIndicator);
  return /*#__PURE__*/React__default.createElement("span", {
    className: className
  });
}
...
class BulkActionsInner extends React.PureComponent {
  ...
  render() {
    ...
    var smallScreenGroup = smallScreen ? /*#__PURE__*/React__default.createElement(reactTransitionGroup.Transition, {
      ...
      var smallScreenGroupClassName = classNames(styles$F.Group, styles$F['Group-smallScreen'], styles$F["Group-".concat(status)]);
      return /*#__PURE__*/React__default.createElement("div", {
    ...
    var largeScreenGroup = smallScreen ? null : /*#__PURE__*/React__default.createElement(reactTransitionGroup.Transition, {
      ...
      var largeScreenGroupClassName = classNames(styles$F.Group, styles$F['Group-largeScreen'], !measuring && styles$F["Group-".concat(status)], measuring && styles$F['Group-measuring']);
      return /*#__PURE__*/React__default.createElement("div", {
...
function TextContainer({
  ...
  var className = classNames(styles$G.TextContainer, spacing && styles$G[variationName('spacing', spacing)]);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
  }, children);
}
...
function CalloutCard({
  ...
  var imageClassName = classNames(styles$H.Image, onDismiss && styles$H.DismissImage);
...
function RadioButton({
  ...
  var ariaDescribedBy = describedBy.length ? describedBy.join(' ') : undefined;
  var inputClassName = classNames(styles$J.Input, newDesignLanguage && keyFocused && styles$J.keyFocused);
  var wrapperClassName = classNames(styles$J.RadioButton, newDesignLanguage && styles$J.newDesignLanguage);
  var iconMarkup = !newDesignLanguage && /*#__PURE__*/React__default.createElement("span", {
    className: styles$J.Icon
  });
  var backdropClassName = classNames(styles$J.Backdrop, mouseOver && styles$J.hover);
...
function ChoiceList({
  ...
  var className = classNames(styles$K.ChoiceList, titleHidden && styles$K.titleHidden);
...
class CollapsibleInner extends React.Component {
  ...
  render() {
    ...
    var wrapperClassName = classNames(styles$L.Collapsible, open && styles$L.open, animating && styles$L.animating, !animating && open && styles$L.fullyOpen, expandOnPrint && styles$L.expandOnPrint);
...
function Navigation({
  ...
  var pipMarkup = columnVisibilityData.map((column, index) => {
    var className = classNames(styles$N.Pip, column.isVisible && styles$N['Pip-visible']);
    return /*#__PURE__*/React__default.createElement("div", {
      className: className,
...
class DataTableInner extends React.PureComponent {
  constructor(...args) {
    ...
    this.defaultRenderRow = (row, index) => {
      var className = classNames(styles$N.TableRow);
      var {
        columnContentTypes,
        truncate = false,
        verticalAlign
  ...
  render() {
    ...
    var className = classNames(styles$N.DataTable, condensed && styles$N.condensed);
    var wrapperClassName = classNames(styles$N.TableWrapper, condensed && styles$N.condensed);
...
var Day = /*#__PURE__*/React.memo(function Day({
  ...
  var dayClassName = classNames(styles$O.Day, selected && styles$O['Day-selected'], disabled && styles$O['Day-disabled'], today && styles$O['Day-today'], (inRange || inHoveringRange) && !disabled && styles$O['Day-inRange'], isLastSelectedDay && styles$O['Day-lastInRange'], isFirstSelectedDay && styles$O['Day-firstInRange'], isHoveringRight && styles$O['Day-hoverRight'], rangeIsDifferent && styles$O['Day-hasRange']);
...
var Weekday = /*#__PURE__*/React.memo(function Weekday({
  ...
  var className = classNames(styles$O.Weekday, current && styles$O['Weekday-current']);
...
function Month({
  ...
  var className = classNames(styles$O.Title, current && styles$O['Month-current']);
  ...
  var weeksMarkup = weeks.map((week, index) => /*#__PURE__*/React__default.createElement("tr", {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    className: className
  }, i18n.translate("Polaris.DatePicker.months.".concat(monthName(month))), ' ', year), /*#__PURE__*/React__default.createElement("thead", null, /*#__PURE__*/React__default.createElement("tr", {
...
function DatePicker({
  ...
  var datePickerClassName = classNames(styles$O.DatePicker, newDesignLanguage && styles$O.newDesignLanguage);
  return /*#__PURE__*/React__default.createElement("div", {
    id: id,
...
function DescriptionList({
  ...
  var className = classNames(styles$P.DescriptionList, spacing === 'tight' && styles$P.spacingTight);
...
function DisplayText({
  ...
  var className = classNames(styles$Q.DisplayText, size && styles$Q[variationName('size', size)]);
  return /*#__PURE__*/React__default.createElement(Element, {
    className: className
  }, children);
}
...
function FileUpload(props) {
  ...
  var buttonStyles = size === 'extraLarge' || size === 'large' ? classNames(styles$R.Button, newDesignLanguage && styles$R.newDesignLanguage, size && size !== 'extraLarge' && styles$R.slim, focused && styles$R.focused, disabled && styles$R.disabled) : null;
  var buttonMarkup = (size === 'extraLarge' || size === 'large') && buttonStyles ? /*#__PURE__*/React__default.createElement("div", {
    className: buttonStyles
  }, actionTitle) : null;
  var actionTitleClassName = classNames(styles$R.ActionTitle, focused && !disabled && styles$R['ActionTitle-focused'], disabled && styles$R['ActionTitle-disabled']);
  var actionTitleMarkup = /*#__PURE__*/React__default.createElement("div", {
    className: actionTitleClassName
  }, actionTitle);
  var fileUploadClassName = classNames(styles$R.FileUpload, newDesignLanguage && styles$R.newDesignLanguage, measuring && styles$R.measuring, size === 'small' && styles$R.FileUploadSmallView);
  var viewMarkup;
...
var DropZone = function DropZone({
  ...
  var classes = classNames(styles$S.DropZone, outline && styles$S.hasOutline, focused && styles$S.focused, (active || dragging) && styles$S.isDragging, disabled && styles$S.isDisabled, newDesignLanguage && styles$S.newDesignLanguage, (internalError || error) && styles$S.hasError, styles$S[variationName('size', size)], measuring && styles$S.measuring);
  var dragOverlay = (active || dragging) && (!internalError || !error) && overlay && overlayMarkup(polarisIcons.DragDropMajor, 'indigo', overlayTextWithDefault);
  var dragErrorOverlay = dragging && (internalError || error) && overlayMarkup(polarisIcons.CircleAlertMajor, 'red', errorOverlayTextWithDefault);
  ...
  function overlayMarkup(icon, color, text) {
    var overlayClass = classNames(styles$S.Overlay, newDesignLanguage && styles$S.newDesignLanguage);
    return /*#__PURE__*/React__default.createElement("div", {
...
function EmptyState({
  ...
  var className = classNames(styles$T.EmptyState, fullWidth && styles$T.fullWidth, newDesignLanguage && styles$T.newDesignLanguage, imageContained && styles$T.imageContained, withinContentContainer ? styles$T.withinContentContainer : styles$T.withinPage);
...
function ExceptionList({
  ...
  var items = itemsList.map((item, index) => {
    ...
    var itemClasses = classNames(styles$V.Item, status && styles$V[variationName('status', status)]);
...
function Tag({
  ...
  var className = classNames(styles$W.Tag, disabled && styles$W.disabled, onClick && styles$W.clickable, onRemove && styles$W.removable, newDesignLanguage && styles$W.newDesignLanguage);
  var ariaLabel = i18n.translate('Polaris.Tag.ariaLabel', {
    children: children || ''
  });
  var buttonClassName = classNames(styles$W.Button, newDesignLanguage && styles$W.newDesignLanguage);
...
class Item$4 extends React.PureComponent {
  ...
  render() {
    ...
    var className = classNames(styles$Y.Item, focused && styles$Y['Item-focused']);
    return /*#__PURE__*/React__default.createElement("div", {
      onBlur: this.handleBlur,
      onFocus: this.handleFocus,
      className: className
...
class ConnectedFilterControl extends React.Component {
  ...
  render() {
    ...
    var className = classNames(styles$Y.ConnectedFilterControl, rightPopoverableActions && styles$Y.right, newDesignLanguage && styles$Y.newDesignLanguage);
    ...
    var RightContainerClassName = classNames(styles$Y.RightContainer, !shouldRenderMoreFiltersButton && styles$Y.RightContainerWithoutMoreFilters);
    ...
    var moreFiltersButtonContainerClassname = classNames(styles$Y.MoreFiltersButtonContainer, actionsToRender.length === 0 && newDesignLanguage && styles$Y.onlyButtonVisible);
...
class FiltersInner extends React.Component {
  ...
  render() {
    ...
    var backdropMarkup = open ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, _ref$e, /*#__PURE__*/React__default.createElement("div", {
    ...
    var filtersContentMarkup = filters.map((filter, index) => {
      ...
      var className = classNames(styles$Z.FilterTriggerContainer, filterIsOpen && styles$Z.open, index === 0 && styles$Z.first, filters.length !== 1 && index === filters.length - 1 && styles$Z.last);
      ...
      var buttonClassName = classNames(styles$Z.FilterTrigger, newDesignLanguage && styles$Z.newDesignLanguage);
      return /*#__PURE__*/React__default.createElement("div", {
        key: filter.key,
        className: className
      }, /*#__PURE__*/React__default.createElement("button", {
    ...
    var filtersContainerHeaderClassname = classNames(styles$Z.FiltersContainerHeader, newDesignLanguage && styles$Z.newDesignLanguage);
    ...
    var filtersDesktopFooterClassname = classNames(styles$Z.FiltersContainerFooter, newDesignLanguage && styles$Z.newDesignLanguage);
    ...
    var filtersMobileContainerContentClassName = classNames(styles$Z.FiltersMobileContainerContent, newDesignLanguage && styles$Z.newDesignLanguage);
    var filtersDesktopContainerContentClassName = classNames(styles$Z.FiltersDesktopContainerContent, newDesignLanguage && styles$Z.newDesignLanguage);
...
function FooterHelp({
  ...
  var className = classNames(styles$_.FooterHelp, newDesignLanguage && styles$_.newDesignLanguage);
  var iconProps = {
...
function Group({
  ...
  var className = classNames(condensed ? styles$$.condensed : styles$$.grouped);
...
function Toast({
  ...
  var className = classNames(styles$10.Toast, error && styles$10.error);
...
function Dialog(_ref) {
  ...
  var classes = classNames(styles$13.Modal, large && styles$13.sizeLarge, limitHeight && styles$13.limitHeight);
...
function CloseButton({
  ...
  var i18n = useI18n();
  var className = classNames(styles$15.CloseButton, !title && styles$15.withoutTitle);
  return /*#__PURE__*/React__default.createElement("button", {
    onClick: onClick,
    className: className,
...
function Section$3({
  ...
  var className = classNames(styles$17.Section, flush && styles$17.flush, subdued && styles$17.subdued);
...
function ContextualSaveBar$1({
  ...
  var logoMarkup = alignContentFlush || contextControl ? null : /*#__PURE__*/React__default.createElement("div", {
    className: styles$19.LogoContainer,
    style: {
      width
    }
  }, imageMarkup);
  var contextControlMarkup = contextControl ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$19.ContextControl
  }, contextControl) : null;
  var contexualSaveBarClassName = classNames(styles$19.ContextualSaveBar, newDesignLanguage && styles$19.newDesignLanguage);
  var contentsClassName = classNames(styles$19.Contents, fullWidth && styles$19.fullWidth);
...
function CSSAnimation({
  ...
  var wrapperClassName = classNames(className, styles$1a[variationName('start', type)], inProp && styles$1a[variationName('end', type)]);
...
class FrameInner extends React.PureComponent {
  ...
  render() {
    ...
    var navClassName = classNames(styles$1b.Navigation, showMobileNavigation && styles$1b['Navigation-visible'], newDesignLanguage && styles$1b['Navigation-newDesignLanguage']);
    ...
    var topBarClassName = classNames(styles$1b.TopBar, newDesignLanguage && styles$1b['TopBar-newDesignLanguage']);
    ...
    var globalRibbonClassName = classNames(styles$1b.GlobalRibbonContainer, newDesignLanguage && styles$1b['GlobalRibbonContainer-newDesignLanguage']);
    var globalRibbonMarkup = globalRibbon ? /*#__PURE__*/React__default.createElement("div", {
      className: globalRibbonClassName,
      ref: this.setGlobalRibbonContainer
    }, globalRibbon) : null;
    var skipClassName = classNames(styles$1b.Skip, skipFocused && styles$1b.focused);
    ...
    var frameClassName = classNames(styles$1b.Frame, navigation && styles$1b.hasNav, topBar && styles$1b.hasTopBar);
    var mainClassName = classNames(styles$1b.Main, newDesignLanguage && styles$1b['Main-newDesignLanguage']);
...
function Section$4({
  ...
  var className = classNames(styles$1d.Section, secondary && styles$1d['Section-secondary'], fullWidth && styles$1d['Section-fullWidth'], oneHalf && styles$1d['Section-oneHalf'], oneThird && styles$1d['Section-oneThird']);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
  }, children);
}
...
var Layout = function Layout({
  ...
  var className = classNames(styles$1d.Layout, newDesignLanguage && styles$1d.newDesignLanguage);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
  }, content);
};
...
function Link({
  ...
  return /*#__PURE__*/React__default.createElement(BannerContext.Consumer, null, BannerContext => {
    ...
    var className = classNames(styles$1e.Link, shouldBeMonochrome && styles$1e.monochrome, newDesignLanguage && styles$1e.newDesignLanguage);
...
class List extends React.PureComponent {
  render() {
    ...
    var className = classNames(styles$1f.List, type && styles$1f[variationName('type', type)]);
...
function MediaCard({
  ...
  var actionClassName = classNames(styles$1g.ActionContainer, portrait && styles$1g.portrait);
  ...
  var mediaCardClassName = classNames(styles$1g.MediaCard, portrait && styles$1g.portrait);
  var mediaContainerClassName = classNames(styles$1g.MediaContainer, portrait && styles$1g.portrait, size === 'small' && styles$1g.sizeSmall);
  var infoContainerClassName = classNames(styles$1g.InfoContainer, portrait && styles$1g.portrait, size === 'small' && styles$1g.sizeSmall);
  return /*#__PURE__*/React__default.createElement(Card, null, /*#__PURE__*/React__default.createElement("div", {
...
function Item$7({
  ...
  if (url == null) {
    var _className = classNames(styles$1h.Item, disabled && styles$1h['Item-disabled'], keyFocused && styles$1h.keyFocused);
  ...
  var itemClassName = classNames(styles$1h.Item, disabled && styles$1h['Item-disabled'], selected && subNavigationItems.length === 0 && styles$1h['Item-selected'], showExpanded && styles$1h.subNavigationActive, keyFocused && styles$1h.keyFocused);
  ...
  if (subNavigationItems.length > 0 && showExpanded) {
    ...
    var SecondaryNavigationClassName = classNames(styles$1h.SecondaryNavigation, !icon && styles$1h['SecondaryNavigation-noIcon']);
  ...
  var className = classNames(styles$1h.ListItem, secondaryAction && styles$1h['ListItem-hasAction']);
  return /*#__PURE__*/React__default.createElement("li", {
    className: className
  }, /*#__PURE__*/React__default.createElement("div", {
...
function Section$5({
  ...
  var className = classNames(styles$1h.Section, separator && styles$1h['Section-withSeparator'], fill && styles$1h['Section-fill']);
  ...
  var toggleClassName = classNames(styles$1h.Item, styles$1h.RollupToggle);
...
var Navigation$1 = function Navigation({
  ...
  var className = classNames(styles$1h.Navigation, newDesignLanguage && styles$1h['Navigation-newDesignLanguage']);
  var context = {
    location,
...
class TooltipOverlay extends React.PureComponent {
  constructor(...args) {
    ...
    this.renderTooltip = overlayDetails => {
      ...
      var containerClassName = classNames(styles$1i.Tooltip, light && styles$1i.light, measuring && styles$1i.measuring, positioning === 'above' && styles$1i.positionedAbove);
      var contentStyles = measuring ? undefined : {
...
function Pagination({
  ...
  var className = classNames(styles$1j.Pagination, plain && styles$1j.plain);
  var previousClassName = classNames(styles$1j.Button, !label && styles$1j.PreviousButton);
  var nextClassName = classNames(styles$1j.Button, !label && styles$1j.NextButton);
...
function Title({
  ...
  var displaySize = isNavigationCollapsed ? 'large' : 'small';
  ...
  var titleMetadataMarkup = titleMetadata ? /*#__PURE__*/React__default.createElement("div", {
    className: classNames(styles$1k.TitleMetadata, newDesignLanguage && styles$1k.newDesignLanguage)
  }, titleMetadata) : null;
  var wrappedTitleMarkup = titleMetadata ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1k.TitleWithMetadataWrapper
  ...
  var pageTitleClassName = thumbnail ? classNames(styles$1k.hasThumbnail) : undefined;
  return /*#__PURE__*/React__default.createElement("div", {
...
function Header$2({
  ...
  var pageTitleMarkup = /*#__PURE__*/React__default.createElement("div", {
  ...
  var additionalMetaDataMarkup = additionalMetaData ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1l.AdditionalMetaData
  }, /*#__PURE__*/React__default.createElement(TextStyle, {
    variation: "subdued"
  }, additionalMetaData)) : null;
  var headerClassNames = classNames(styles$1l.Header, titleHidden && styles$1l.titleHidden, separator && styles$1l.separator, navigationMarkup && styles$1l.hasNavigation, actionMenuMarkup && styles$1l.hasActionMenu, isNavigationCollapsed && styles$1l.mobileView, newDesignLanguage && styles$1l.newDesignLanguage);
...
function Page(_ref) {
  ...
  var className = classNames(styles$1m.Page, fullWidth && styles$1m.fullWidth, narrowWidth && styles$1m.narrowWidth, newDesignLanguage && styles$1m.newDesignLanguage);
...
function ProgressBar({
  ...
  var i18n = useI18n();
  var className = classNames(styles$1o.ProgressBar, size && styles$1o[variationName('size', size)]);
...
class DualThumb extends React.Component {
  ...
  render() {
    ...
    var ariaDescribedBy = describedBy.length ? describedBy.join(' ') : undefined;
    var trackWrapperClassName = classNames(styles$1p.TrackWrapper, error && styles$1p.error, disabled && styles$1p.disabled);
    var thumbLowerClassName = classNames(styles$1p.Thumbs, styles$1p.ThumbLower, disabled && styles$1p.disabled, this.context && this.context.newDesignLanguage && styles$1p.newDesignLanguage);
    var thumbUpperClassName = classNames(styles$1p.Thumbs, styles$1p.ThumbUpper, disabled && styles$1p.disabled, this.context && this.context.newDesignLanguage && styles$1p.newDesignLanguage);
    ...
    var outputLowerClassName = classNames(styles$1p.Output, styles$1p.OutputLower);
    ...
    var outputUpperClassName = classNames(styles$1p.Output, styles$1p.OutputUpper);
...
function SingleThumb(props) {
  ...
  var className = classNames(styles$1q.SingleThumb, error && styles$1q.error, disabled && styles$1q.disabled);
  var inputClassNames = classNames(styles$1q.Input, newDesignLanguage && styles$1q.newDesignLanguage);
  return /*#__PURE__*/React__default.createElement(Labelled, {
    id: id,
    label: label,
    error: error,
...
class BaseResourceItem extends React.Component {
  ...
  render() {
    ...
    var className = classNames(styles$1r.ResourceItem, newDesignLanguage && styles$1r.newDesignLanguage, focused && styles$1r.focused, selectable && styles$1r.selectable, selected && styles$1r.selected, selectMode && styles$1r.selectMode, persistActions && styles$1r.persistActions, focusedInner && styles$1r.focusedInner);
    var listItemClassName = classNames(styles$1r.ListItem, focused && !focusedInner && styles$1r.focused, newDesignLanguage && styles$1r.newDesignLanguage);
    ...
    var containerClassName = classNames(styles$1r.Container, verticalAlignment && styles$1r[variationName('alignment', verticalAlignment)]);
...
function Select({
  ...
  var className = classNames(styles$1s.Select, error && styles$1s.error, disabled && styles$1s.disabled, newDesignLanguage && styles$1s.newDesignLanguage);
...
function SkeletonPage({
  ...
  var className = classNames(styles$1y.Page, fullWidth && styles$1y.fullWidth, narrowWidth && styles$1y.narrowWidth, newDesignLanguage && styles$1y.newDesignLanguage);
  var headerClassName = classNames(styles$1y.Header, breadcrumbs && styles$1y['Header-hasBreadcrumbs'], secondaryActions && styles$1y['Header-hasSecondaryActions']);
...
function SkeletonThumbnail({
  ...
  var className = classNames(styles$1z.SkeletonThumbnail, size && styles$1z[variationName('size', size)]);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
  });
}
...
class Item$8 extends React.PureComponent {
  ...
  render() {
    ...
    var classname = classNames(styles$1A.Item, newDesignLanguage && styles$1A.newDesignLanguage);
    var sharedProps = {
      id,
...
class List$1 extends React.PureComponent {
  ...
  render() {
    ...
    var classname = classNames(styles$1A.List, newDesignLanguage && styles$1A.newDesignLanguage);
    return /*#__PURE__*/React__default.createElement("ul", {
      className: classname,
...
function Panel({
  ...
  var className = classNames(styles$1A.Panel, hidden && styles$1A['Panel-hidden']);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className,
    id: id,
    role: "tabpanel",
...
function Tab({
  ...
  var className = classNames(styles$1A.Tab, selected && styles$1A['Tab-selected']);
  var tabIndex;
  ...
  var tabContainerClassNames = classNames(styles$1A.TabContainer, selected && styles$1A.Underline, newDesignLanguage && styles$1A.newDesignLanguage);
  var tabTitleClassNames = classNames(styles$1A.Title, newDesignLanguage && styles$1A.newDesignLanguage);
...
var TabMeasurer = /*#__PURE__*/React.memo(function TabMeasurer({
  ...
  var classname = classNames(styles$1A.Tabs, styles$1A.TabMeasurer);
  return /*#__PURE__*/React__default.createElement("div", {
    className: classname,
    ref: containerNode
  }, /*#__PURE__*/React__default.createElement(EventListener, {
...
class TabsInner extends React.PureComponent {
  ...
  render() {
    ...
    var classname = classNames(styles$1A.Tabs, fitted && styles$1A.fitted, disclosureActivatorVisible && styles$1A.fillSpace, newDesignLanguage && styles$1A.newDesignLanguage);
    var wrapperClassName = classNames(styles$1A.Wrapper, newDesignLanguage && styles$1A.newDesignLanguage);
    var disclosureTabClassName = classNames(styles$1A.DisclosureTab, disclosureActivatorVisible && styles$1A['DisclosureTab-visible']);
    var disclosureActivatorClassName = classNames(styles$1A.TabContainer, newDesignLanguage && styles$1A.newDesignLanguage);
    var disclosureButtonClassName = classNames(styles$1A.DisclosureActivator, hasCustomDisclosure && styles$1A.Tab);
    var disclosureButtonContentWrapperClassName = classNames(styles$1A.Title, hasCustomDisclosure && styles$1A.titleWithIcon);
    var disclosureButtonContent = hasCustomDisclosure ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, disclosureText, _ref$q) : _ref2$8;
    var disclosureButton = /*#__PURE__*/React__default.createElement("button", {
      type: "button",
    ...
    var activator = disclosureText ? /*#__PURE__*/React__default.createElement("div", {
...
function Thumbnail({
  ...
  var className = classNames(styles$1B.Thumbnail, size && styles$1B[variationName('size', size)]);
  return /*#__PURE__*/React__default.createElement("span", {
    className: className
  }, /*#__PURE__*/React__default.createElement(Image, {
    alt: alt,
    source: source,
    className: styles$1B.Image
  }));
}
...
function SearchDismissOverlay({
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, visible ? _ref$r : null, /*#__PURE__*/React__default.createElement("div", {
    ref: node,
    className: classNames(styles$1C.SearchDismissOverlay, visible && styles$1C.visible),
...
function Search({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: classNames(styles$1D.Search, visible && styles$1D.visible)
...
function SearchField({
  ...
  var className = classNames(styles$1E.SearchField, (focused || active || forceActive) && styles$1E.focused, newDesignLanguage && styles$1E['SearchField-newDesignLanguage']);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className,
    onFocus: handleFocus,
    onBlur: handleBlur
...
var TopBar = function TopBar({
  ...
  var iconClassName = classNames(styles$1J.NavigationIcon, focused && styles$1J.focused);
  ...
  var className = classNames(styles$1J.TopBar, newDesignLanguage && styles$1J['TopBar-newDesignLanguage']);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
